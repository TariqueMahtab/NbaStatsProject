...
- Create Angular project with ng: `ng new nbastatsproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`nbastatsproject.client.esproj`).
